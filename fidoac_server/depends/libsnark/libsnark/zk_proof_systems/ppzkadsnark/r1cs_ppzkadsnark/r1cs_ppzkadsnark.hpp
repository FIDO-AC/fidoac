 ...
 *****************************************************************************
 ...
 - ppzkADSNARK = "PreProcessing Zero-Knowledge Succinct Non-interactive ARgument
of Knowledge Over Authenticated Data"
...
template<typename ppT> class r1cs_ppzkadsnark_pub_auth_prms;
...
public:
    ...
    r1cs_ppzkadsnark_pub_auth_prms<ppT> &operator=(
        const r1cs_ppzkadsnark_pub_auth_prms<ppT> &other) = default;
    r1cs_ppzkadsnark_pub_auth_prms(
        const r1cs_ppzkadsnark_pub_auth_prms<ppT> &other) = default;
    r1cs_ppzkadsnark_pub_auth_prms(
        r1cs_ppzkadsnark_pub_auth_prms<ppT> &&other) = default;
    ...
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_ppzkadsnark_pub_auth_prms<ppT> &pap);
};

/******************************** Secret authentication key
 * ********************************/

template<typename ppT> class r1cs_ppzkadsnark_sec_auth_key;
...
public:
    ...
    r1cs_ppzkadsnark_sec_auth_key<ppT> &operator=(
        const r1cs_ppzkadsnark_sec_auth_key<ppT> &other) = default;
    r1cs_ppzkadsnark_sec_auth_key(
        const r1cs_ppzkadsnark_sec_auth_key<ppT> &other) = default;
    r1cs_ppzkadsnark_sec_auth_key(r1cs_ppzkadsnark_sec_auth_key<ppT> &&other) =
        default;
    r1cs_ppzkadsnark_sec_auth_key(
        libff::Fr<snark_pp<ppT>> &&i,
        r1cs_ppzkadsnark_skT<ppT> &&skp,
        r1cs_ppzkadsnark_prfKeyT<ppT> &&S)
        : i(std::move(i)), skp(std::move(skp)), S(std::move(S)){};

    bool operator==(const r1cs_ppzkadsnark_sec_auth_key<ppT> &other) const;
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_ppzkadsnark_sec_auth_key<ppT> &key);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_ppzkadsnark_sec_auth_key<ppT> &key);
};

/******************************** Public authentication key
 * ********************************/

template<typename ppT> class r1cs_ppzkadsnark_pub_auth_key;
...
public:
    ...
    r1cs_ppzkadsnark_pub_auth_key<ppT> &operator=(
        const r1cs_ppzkadsnark_pub_auth_key<ppT> &other) = default;
    r1cs_ppzkadsnark_pub_auth_key(
        const r1cs_ppzkadsnark_pub_auth_key<ppT> &other) = default;
    r1cs_ppzkadsnark_pub_auth_key(r1cs_ppzkadsnark_pub_auth_key<ppT> &&other) =
        default;
    r1cs_ppzkadsnark_pub_auth_key(
        libff::G2<snark_pp<ppT>> &&minusI2, r1cs_ppzkadsnark_vkT<ppT> &&vkp)
    ...
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_ppzkadsnark_pub_auth_key<ppT> &key);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_ppzkadsnark_pub_auth_key<ppT> &key);
};

/******************************** Authentication key material
 * ********************************/

template<typename ppT> class r1cs_ppzkadsnark_auth_keys
{
public:
    ...
    r1cs_ppzkadsnark_auth_keys(r1cs_ppzkadsnark_auth_keys<ppT> &&other) =
        default;
    r1cs_ppzkadsnark_auth_keys(
        r1cs_ppzkadsnark_pub_auth_prms<ppT> &&pap,
        r1cs_ppzkadsnark_pub_auth_key<ppT> &&pak,
        r1cs_ppzkadsnark_sec_auth_key<ppT> &&sak)
        : pap(std::move(pap)), pak(std::move(pak)), sak(std::move(sak))
    {
    }
};
...
template<typename ppT> class r1cs_ppzkadsnark_auth_data;
...
public:
    ...
    r1cs_ppzkadsnark_auth_data<ppT> &operator=(
        const r1cs_ppzkadsnark_auth_data<ppT> &other) = default;
    r1cs_ppzkadsnark_auth_data(const r1cs_ppzkadsnark_auth_data<ppT> &other) =
        default;
    r1cs_ppzkadsnark_auth_data(r1cs_ppzkadsnark_auth_data<ppT> &&other) =
        default;
    r1cs_ppzkadsnark_auth_data(
        libff::Fr<snark_pp<ppT>> &&mu,
        libff::G2<snark_pp<ppT>> &&Lambda,
    ...
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_ppzkadsnark_auth_data<ppT> &key);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_ppzkadsnark_auth_data<ppT> &key);
};

/******************************** Proving key ********************************/

template<typename ppT> class r1cs_ppzkadsnark_proving_key;
...
public:
    ...
    r1cs_ppzkadsnark_proving_key<ppT> &operator=(
        const r1cs_ppzkadsnark_proving_key<ppT> &other) = default;
    r1cs_ppzkadsnark_proving_key(
        const r1cs_ppzkadsnark_proving_key<ppT> &other) = default;
    r1cs_ppzkadsnark_proving_key(r1cs_ppzkadsnark_proving_key<ppT> &&other) =
        default;
    r1cs_ppzkadsnark_proving_key(
        knowledge_commitment_vector<
            libff::G1<snark_pp<ppT>>,
    ...
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_ppzkadsnark_proving_key<ppT> &pk);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_ppzkadsnark_proving_key<ppT> &pk);
};

/******************************* Verification key ****************************/

template<typename ppT> class r1cs_ppzkadsnark_verification_key;
...
public:
    ...
    r1cs_ppzkadsnark_verification_key(
        const libff::G2<snark_pp<ppT>> &alphaA_g2,
    ...
    size_t G1_size() const { return 3 + Ain.size(); }

    size_t G2_size() const { return 5; }

    size_t size_in_bits() const
    {
        return G1_size() * libff::G1<snark_pp<ppT>>::size_in_bits() +
               G2_size() *
                   libff::G2<snark_pp<ppT>>::size_in_bits(); // possible zksnark
                                                             // bug
    }
    ...
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_ppzkadsnark_verification_key<ppT> &vk);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_ppzkadsnark_verification_key<ppT> &vk);

    static r1cs_ppzkadsnark_verification_key<ppT> dummy_verification_key(
        const size_t input_size);
};

/************************ Processed verification key *************************/

template<typename ppT> class r1cs_ppzkadsnark_processed_verification_key;
...
public:
    ...
    bool operator==(
        const r1cs_ppzkadsnark_processed_verification_key &other) const;
    friend std::ostream &operator<<<ppT>(
        std::ostream &out,
        const r1cs_ppzkadsnark_processed_verification_key<ppT> &pvk);
...
/**
 * A key pair for the R1CS ppzkADSNARK, which consists of a proving key and a
 * verification key.
 */
template<typename ppT> class r1cs_ppzkadsnark_keypair
{
public:
    ...
    r1cs_ppzkadsnark_keypair(const r1cs_ppzkadsnark_keypair<ppT> &other) =
        default;
...
template<typename ppT> class r1cs_ppzkadsnark_proof;
...
public:
    ...
    size_t G1_size() const { return 10; }
    ...
    {
        return G1_size() * libff::G1<snark_pp<ppT>>::size_in_bits() +
               G2_size() * libff::G2<snark_pp<ppT>>::size_in_bits();
    }
    ...
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_ppzkadsnark_proof<ppT> &proof);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_ppzkadsnark_proof<ppT> &proof);
};
...
processed verification key. In the latter case, we call the algorithm an "online
verifier".
