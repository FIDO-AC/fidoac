 ...
 *****************************************************************************
 ...
 where most of the work is done. See gadgets/ram_universal_gadget.hpp for
 details.
...
template<typename ramT> class ram_to_r1cs
{
public:
    ...
    static std::vector<ram_base_field<ramT>> pack_primary_input_address_and_value(
