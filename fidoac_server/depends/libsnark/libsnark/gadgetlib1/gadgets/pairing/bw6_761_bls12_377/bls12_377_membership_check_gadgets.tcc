...
#ifndef LIBSNARK_GADGETLIB1_GADGETS_PAIRING_BW6_761_BLS12_377_BLS12_377_MEMBERSHIP_CHECK_GADGETS_TCC_
#define LIBSNARK_GADGETLIB1_GADGETS_PAIRING_BW6_761_BLS12_377_BLS12_377_MEMBERSHIP_CHECK_GADGETS_TCC_
    ...
    const std::string &annotation_prefix)
{
    ...
    Fp6_3over2_variable<Fq6T> y_as_Fp6(
        pb,
        *g2.Y,
        Fp2_variable<FqeT>(pb, FqeT::zero(), FMT(annotation_prefix, " Fqe(0)")),
        Fp2_variable<FqeT>(pb, FqeT::zero(), FMT(annotation_prefix, " Fqe(0)")),
...
bls12_377_G2_membership_check_gadget<wppT>::
    ...
    , _t_times_psi_P_minus_P(
          ...
          _psi_P_minus_P.result,
          G2_variable<wppT>(pb, FMT(annotation_prefix, " [t](psi(P)-P)")),
    ...
    , _P_plus_t_times_psi_P_minus_P(
          ...
          G2_variable<wppT>(pb, FMT(annotation_prefix, " P-[t](psi(P)-P)")),
          FMT(annotation_prefix, " _P_plus_t_times_psi_P_minus_P"))
    // P + [t](\psi(P) - P) = \psi^2(P)
    , _h1_r_P_equals_zero(
          pb,
          _P_plus_t_times_psi_P_minus_P.result,
          bls12_377_g2_untwist_frobenius_twist(
...
#endif // LIBSNARK_GADGETLIB1_GADGETS_PAIRING_BW6_761_BLS12_377_BLS12_377_MEMBERSHIP_CHECK_GADGETS_TCC_
