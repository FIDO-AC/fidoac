...
tinyram_protoboard<FieldT>::tinyram_protoboard(
...
template<typename FieldT>
tinyram_gadget<FieldT>::tinyram_gadget(
    tinyram_protoboard<FieldT> &pb, const std::string &annotation_prefix)
    : gadget<FieldT>(pb, annotation_prefix), pb(pb)
{
}

template<typename FieldT>
tinyram_standard_gadget<FieldT>::tinyram_standard_gadget(
    tinyram_protoboard<FieldT> &pb, const std::string &annotation_prefix)
