...
bool r1cs_ppzksnark_proving_key<ppT>::operator==(
    const r1cs_ppzksnark_proving_key<ppT> &other) const
{
    return (
...
template<typename ppT>
bool r1cs_ppzksnark_proof<ppT>::operator==(
    const r1cs_ppzksnark_proof<ppT> &other) const
{
    return (
...
template<typename ppT>
r1cs_ppzksnark_verification_key<ppT> r1cs_ppzksnark_verification_key<
    ...
    const r1cs_ppzksnark_constraint_system<ppT> &cs)
{
    ...
    // consrtuct the same-coefficient-check query (must happen before zeroing
    ...
    libff::G1_vector<ppT> H_query =
        batch_exp(libff::Fr<ppT>::size_in_bits(), g1_window, g1_table, Ht);
    ...
    libff::G1_vector<ppT> K_query =
        batch_exp(libff::Fr<ppT>::size_in_bits(), g1_window, g1_table, Kt);
    if (BaseForm == libff::multi_exp_base_form_special) {
    ...
    libff::G1<ppT> encoded_IC_base =
        (rA * IC_coefficients[0]) * libff::G1<ppT>::one();
    ...
    r1cs_ppzksnark_verification_key<ppT> vk =
        r1cs_ppzksnark_verification_key<ppT>(
            ...
            rC_Z_g2,
            encoded_IC_query);
    r1cs_ppzksnark_proving_key<ppT> pk = r1cs_ppzksnark_proving_key<ppT>(
        std::move(A_query),
        std::move(B_query),
        std::move(C_query),
        std::move(H_query),
    ...
    const r1cs_ppzksnark_proof<ppT> &proof)
{
    ...
    libff::G1_precomp<ppT> proof_g_A_g_precomp =
        ppT::precompute_G1(proof.g_A.g);
    libff::G1_precomp<ppT> proof_g_A_h_precomp =
        ppT::precompute_G1(proof.g_A.h);
    libff::Fqk<ppT> kc_A_1 =
        ppT::miller_loop(proof_g_A_g_precomp, pvk.vk_alphaA_g2_precomp);
    libff::Fqk<ppT> kc_A_2 =
        ppT::miller_loop(proof_g_A_h_precomp, pvk.pp_G2_one_precomp);
    libff::GT<ppT> kc_A =
        ppT::final_exponentiation(kc_A_1 * kc_A_2.unitary_inverse());
    ...
    libff::G2_precomp<ppT> proof_g_B_g_precomp =
        ppT::precompute_G2(proof.g_B.g);
    libff::G1_precomp<ppT> proof_g_B_h_precomp =
        ppT::precompute_G1(proof.g_B.h);
    libff::Fqk<ppT> kc_B_1 =
        ppT::miller_loop(pvk.vk_alphaB_g1_precomp, proof_g_B_g_precomp);
    libff::Fqk<ppT> kc_B_2 =
        ppT::miller_loop(proof_g_B_h_precomp, pvk.pp_G2_one_precomp);
    libff::GT<ppT> kc_B =
        ppT::final_exponentiation(kc_B_1 * kc_B_2.unitary_inverse());
    ...
    libff::G1_precomp<ppT> proof_g_C_g_precomp =
        ppT::precompute_G1(proof.g_C.g);
    libff::G1_precomp<ppT> proof_g_C_h_precomp =
        ppT::precompute_G1(proof.g_C.h);
    libff::Fqk<ppT> kc_C_1 =
        ppT::miller_loop(proof_g_C_g_precomp, pvk.vk_alphaC_g2_precomp);
    libff::Fqk<ppT> kc_C_2 =
        ppT::miller_loop(proof_g_C_h_precomp, pvk.pp_G2_one_precomp);
    libff::GT<ppT> kc_C =
        ppT::final_exponentiation(kc_C_1 * kc_C_2.unitary_inverse());
    ...
    // equivalently, via pairings, that e(g^(A+acc), g^B) = e(g^H, g^Z) + e(g^C,
    // g^1)
    libff::G1_precomp<ppT> proof_g_A_g_acc_precomp =
        ppT::precompute_G1(proof.g_A.g + acc);
    libff::G1_precomp<ppT> proof_g_H_precomp = ppT::precompute_G1(proof.g_H);
    libff::Fqk<ppT> QAP_1 =
        ppT::miller_loop(proof_g_A_g_acc_precomp, proof_g_B_g_precomp);
    libff::Fqk<ppT> QAP_23 = ppT::double_miller_loop(
        proof_g_H_precomp,
        pvk.vk_rC_Z_g2_precomp,
        proof_g_C_g_precomp,
        pvk.pp_G2_one_precomp);
    libff::GT<ppT> QAP =
        ppT::final_exponentiation(QAP_1 * QAP_23.unitary_inverse());
    ...
    libff::G1_precomp<ppT> proof_g_A_g_acc_C_precomp =
        ppT::precompute_G1((proof.g_A.g + acc) + proof.g_C.g);
    libff::Fqk<ppT> K_1 =
        ppT::miller_loop(proof_g_K_precomp, pvk.vk_gamma_g2_precomp);
    libff::Fqk<ppT> K_23 = ppT::double_miller_loop(
    ...
    const r1cs_ppzksnark_proof<ppT> &proof)
{
    ...
    bool result =
        r1cs_ppzksnark_online_verifier_weak_IC<ppT>(pvk, primary_input, proof);
    ...
    const r1cs_ppzksnark_proof<ppT> &proof)
{
    ...
    if (pvk.encoded_IC_query.domain_size() != primary_input.size()) {
        ...
        result =
            r1cs_ppzksnark_online_verifier_weak_IC(pvk, primary_input, proof);
    }
    ...
    const r1cs_ppzksnark_proof<ppT> &proof)
{
    ...
    r1cs_ppzksnark_processed_verification_key<ppT> pvk =
        r1cs_ppzksnark_verifier_process_vk<ppT>(vk);
    bool result = r1cs_ppzksnark_online_verifier_strong_IC<ppT>(
    ...
    const r1cs_ppzksnark_proof<ppT> &proof)
{
    ...
    libff::affine_ate_G2_precomp<ppT> pvk_pp_G2_one_precomp =
        ppT::affine_ate_precompute_G2(libff::G2<ppT>::one());
    libff::affine_ate_G2_precomp<ppT> pvk_vk_alphaA_g2_precomp =
        ppT::affine_ate_precompute_G2(vk.alphaA_g2);
    libff::affine_ate_G1_precomp<ppT> pvk_vk_alphaB_g1_precomp =
        ppT::affine_ate_precompute_G1(vk.alphaB_g1);
    libff::affine_ate_G2_precomp<ppT> pvk_vk_alphaC_g2_precomp =
        ppT::affine_ate_precompute_G2(vk.alphaC_g2);
    libff::affine_ate_G2_precomp<ppT> pvk_vk_rC_Z_g2_precomp =
        ppT::affine_ate_precompute_G2(vk.rC_Z_g2);
    libff::affine_ate_G2_precomp<ppT> pvk_vk_gamma_g2_precomp =
        ppT::affine_ate_precompute_G2(vk.gamma_g2);
    libff::affine_ate_G1_precomp<ppT> pvk_vk_gamma_beta_g1_precomp =
        ppT::affine_ate_precompute_G1(vk.gamma_beta_g1);
    libff::affine_ate_G2_precomp<ppT> pvk_vk_gamma_beta_g2_precomp =
        ppT::affine_ate_precompute_G2(vk.gamma_beta_g2);

    libff::enter_block("Compute input-dependent part of A");
    const accumulation_vector<libff::G1<ppT>> accumulated_IC =
        vk.encoded_IC_query.template accumulate_chunk<libff::Fr<ppT>>(
            primary_input.begin(), primary_input.end(), 0);
    ...
    bool result = true;
    libff::enter_block("Check knowledge commitment for A is valid");
    libff::affine_ate_G1_precomp<ppT> proof_g_A_g_precomp =
        ppT::affine_ate_precompute_G1(proof.g_A.g);
    libff::affine_ate_G1_precomp<ppT> proof_g_A_h_precomp =
        ppT::affine_ate_precompute_G1(proof.g_A.h);
    libff::Fqk<ppT> kc_A_miller = ppT::affine_ate_e_over_e_miller_loop(
        proof_g_A_g_precomp,
    ...
    libff::enter_block("Check knowledge commitment for B is valid");
    libff::affine_ate_G2_precomp<ppT> proof_g_B_g_precomp =
        ppT::affine_ate_precompute_G2(proof.g_B.g);
    libff::affine_ate_G1_precomp<ppT> proof_g_B_h_precomp =
        ppT::affine_ate_precompute_G1(proof.g_B.h);
    libff::Fqk<ppT> kc_B_miller = ppT::affine_ate_e_over_e_miller_loop(
    ...
    libff::enter_block("Check knowledge commitment for C is valid");
    libff::affine_ate_G1_precomp<ppT> proof_g_C_g_precomp =
        ppT::affine_ate_precompute_G1(proof.g_C.g);
    libff::affine_ate_G1_precomp<ppT> proof_g_C_h_precomp =
        ppT::affine_ate_precompute_G1(proof.g_C.h);
    libff::Fqk<ppT> kc_C_miller = ppT::affine_ate_e_over_e_miller_loop(
        proof_g_C_g_precomp,
    ...
    libff::enter_block("Check QAP divisibility");
    libff::affine_ate_G1_precomp<ppT> proof_g_A_g_acc_precomp =
        ppT::affine_ate_precompute_G1(proof.g_A.g + acc);
    libff::affine_ate_G1_precomp<ppT> proof_g_H_precomp =
        ppT::affine_ate_precompute_G1(proof.g_H);
    libff::Fqk<ppT> QAP_miller = ppT::affine_ate_e_times_e_over_e_miller_loop(
        proof_g_H_precomp,
    ...
    libff::enter_block("Check same coefficients were used");
    libff::affine_ate_G1_precomp<ppT> proof_g_K_precomp =
        ppT::affine_ate_precompute_G1(proof.g_K);
    libff::affine_ate_G1_precomp<ppT> proof_g_A_g_acc_C_precomp =
        ppT::affine_ate_precompute_G1((proof.g_A.g + acc) + proof.g_C.g);
    libff::Fqk<ppT> K_miller = ppT::affine_ate_e_times_e_over_e_miller_loop(
        proof_g_A_g_acc_C_precomp,
