...
bn128_Fq12 bn128_pp::miller_loop(
...
bn128_Fq12 bn128_pp::double_miller_loop(
    ...
    const bn128_ate_G2_precomp &prec_Q2)
{
    ...
    bn128_Fq12 result =
        bn128_double_ate_miller_loop(prec_P1, prec_Q1, prec_P2, prec_Q2);
    leave_block("Call to double_miller_loop<bn128_pp>");
    return result;
}

bn128_Fq12 bn128_pp::pairing(const bn128_G1 &P, const bn128_G2 &Q)
{
...
bn128_GT bn128_pp::reduced_pairing(const bn128_G1 &P, const bn128_G2 &Q)
{
