...
template<typename FieldT> class lastbits_gadget : public gadget<FieldT>
{
public:
...
template<typename FieldT> class XOR3_gadget : public gadget<FieldT>
{
private:
...
template<typename FieldT> class small_sigma_gadget : public gadget<FieldT>
{
private:
...
/* Page 10 of http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf */
template<typename FieldT> class big_sigma_gadget : public gadget<FieldT>
{
private:
...
/* Page 10 of http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf */
template<typename FieldT> class choice_gadget : public gadget<FieldT>
{
private:
    pb_variable_array<FieldT> result_bits;
...
/* Page 10 of http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf */
template<typename FieldT> class majority_gadget : public gadget<FieldT>
{
private:
    pb_variable_array<FieldT> result_bits;
    std::shared_ptr<packing_gadget<FieldT>> pack_result;
