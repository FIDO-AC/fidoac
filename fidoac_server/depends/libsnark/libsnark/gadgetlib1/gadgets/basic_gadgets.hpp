...
template<typename FieldT> class multipacking_gadget : public gadget<FieldT>
{
private:
...
template<typename FieldT> class field_vector_copy_gadget : public gadget<FieldT>
{
public:
...
template<typename FieldT> class bit_vector_copy_gadget : public gadget<FieldT>
{
public:
...
template<typename FieldT> class dual_variable_gadget : public gadget<FieldT>
{
private:
...
public:
        ...
        : gadget<FieldT>(pb, annotation_prefix)
    {
        ...
        consistency_check.reset(new packing_gadget<FieldT>(
            pb,
            bits,
            packed,
...
public:
        ...
        , less_or_eq(less_or_eq)
    {
        ...
        alpha_packed.allocate(
            pb, FMT(this->annotation_prefix, " alpha_packed"));
        not_all_zeros.allocate(
            pb, FMT(this->annotation_prefix, " not_all_zeros"));
        ...
        all_zeros_test.reset(new disjunction_gadget<FieldT>(
            pb,
...
class loose_multiplexing_gadget : public gadget<FieldT>
{
    /*
      ...
      however if index is in bounds we can also set success_flag to 0 (and then
      result will be forced to be 0)
    */
public:
    pb_variable_array<FieldT> alpha;
...
public:
        ...
        , success_flag(success_flag)
    {
        ...
        compute_result.reset(new inner_product_gadget<FieldT>(
            pb,
            alpha,
            arr,
            result,
