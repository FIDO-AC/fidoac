/** @file
 ********************************************************************************
 Declares functions for computing Ate pairings over the bn128 curves, split into
 a offline and online stages.
 ********************************************************************************
...
struct bn128_ate_G1_precomp {
    ...
    friend std::ostream &operator<<(
        std::ostream &out, const bn128_ate_G1_precomp &prec_P);
    friend std::istream &operator>>(
        std::istream &in, bn128_ate_G1_precomp &prec_P);
};
...
struct bn128_ate_G2_precomp {
    ...
    friend std::ostream &operator<<(
        std::ostream &out, const bn128_ate_G2_precomp &prec_Q);
    friend std::istream &operator>>(
        std::istream &in, bn128_ate_G2_precomp &prec_Q);
};
...
bn128_Fq12 bn128_double_ate_miller_loop(
...
bn128_Fq12 bn128_ate_miller_loop(
