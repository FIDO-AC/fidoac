/** @file
 ********************************************************************************
 Implements functions for computing Ate pairings over the bn128 curves, split
 into a offline and online stages.
 ********************************************************************************
...
{
    return (
        this->P[0] == other.P[0] && this->P[1] == other.P[1] &&
        this->P[2] == other.P[2]);
}
...
{
    if (!(this->Q[0] == other.Q[0] && this->Q[1] == other.Q[1] &&
          this->Q[2] == other.Q[2] &&
