...
template<typename ppT> class r1cs_se_ppzksnark_proving_key;
...
public:
    ...
    r1cs_se_ppzksnark_proving_key<ppT> &operator=(
        const r1cs_se_ppzksnark_proving_key<ppT> &other) = default;
    r1cs_se_ppzksnark_proving_key(
        const r1cs_se_ppzksnark_proving_key<ppT> &other) = default;
    r1cs_se_ppzksnark_proving_key(r1cs_se_ppzksnark_proving_key<ppT> &&other) =
        default;
    r1cs_se_ppzksnark_proving_key(
        libff::G1_vector<ppT> &&A_query,
        libff::G2_vector<ppT> &&B_query,
    ...
    size_t G2_size() const { return B_query.size() + 1; }
    ...
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_se_ppzksnark_proving_key<ppT> &pk);
};

/******************************* Verification key ****************************/

template<typename ppT> class r1cs_se_ppzksnark_verification_key;
...
public:
    ...
    size_t G1_size() const { return 2 + query.size(); }

    size_t G2_size() const { return 3; }
    ...
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_se_ppzksnark_verification_key<ppT> &vk);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_se_ppzksnark_verification_key<ppT> &vk);

    static r1cs_se_ppzksnark_verification_key<ppT> dummy_verification_key(
        const size_t input_size);
};

/************************ Processed verification key *************************/

template<typename ppT> class r1cs_se_ppzksnark_processed_verification_key;
...
public:
    ...
    bool operator==(
        const r1cs_se_ppzksnark_processed_verification_key &other) const;
    friend std::ostream &operator<<<ppT>(
        std::ostream &out,
        const r1cs_se_ppzksnark_processed_verification_key<ppT> &pvk);
...
/**
 * A key pair for the R1CS SEppzkSNARK, which consists of a proving key and a
 * verification key.
 */
template<typename ppT> class r1cs_se_ppzksnark_keypair
{
public:
    ...
    r1cs_se_ppzksnark_keypair(const r1cs_se_ppzksnark_keypair<ppT> &other) =
        default;
...
template<typename ppT> class r1cs_se_ppzksnark_proof;
...
public:
    ...
    r1cs_se_ppzksnark_proof(
        libff::G1<ppT> &&A, libff::G2<ppT> &&B, libff::G1<ppT> &&C)
    ...
    friend std::ostream &operator<<<ppT>(
        std::ostream &out, const r1cs_se_ppzksnark_proof<ppT> &proof);
    friend std::istream &operator>>
        <ppT>(std::istream &in, r1cs_se_ppzksnark_proof<ppT> &proof);
};
