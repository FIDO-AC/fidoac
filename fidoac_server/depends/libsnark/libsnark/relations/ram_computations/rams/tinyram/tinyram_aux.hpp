...
const static int tinyram_opcodes_register[] = {
    tinyram_opcode_AND,   tinyram_opcode_OR,    tinyram_opcode_XOR,
    tinyram_opcode_NOT,   tinyram_opcode_ADD,   tinyram_opcode_SUB,
    tinyram_opcode_MULL,  tinyram_opcode_UMULH, tinyram_opcode_SMULH,
    tinyram_opcode_UDIV,  tinyram_opcode_UMOD,  tinyram_opcode_SHL,
    tinyram_opcode_SHR,

    tinyram_opcode_CMPE,  tinyram_opcode_CMPA,  tinyram_opcode_CMPAE,
    tinyram_opcode_CMPG,  tinyram_opcode_CMPGE,
...
const static int tinyram_opcodes_control_flow[] = {
    tinyram_opcode_JMP, tinyram_opcode_CJMP, tinyram_opcode_CNJMP};
...
public:
    ...
    memory_contents initial_memory_contents(
    ...
    friend std::istream &operator>>(
        std::istream &in, tinyram_architecture_params &ap);
