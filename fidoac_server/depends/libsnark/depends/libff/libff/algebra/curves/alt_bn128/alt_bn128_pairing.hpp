...
struct alt_bn128_ate_G1_precomp {
    ...
    friend std::istream &operator>>(
        std::istream &in, alt_bn128_ate_G1_precomp &prec_P);
};
...
struct alt_bn128_ate_ell_coeffs {
    ...
    friend std::ostream &operator<<(
        std::ostream &out, const alt_bn128_ate_ell_coeffs &dc);
    friend std::istream &operator>>(
        std::istream &in, alt_bn128_ate_ell_coeffs &dc);
};
...
struct alt_bn128_ate_G2_precomp {
    ...
    friend std::istream &operator>>(
        std::istream &in, alt_bn128_ate_G2_precomp &prec_Q);
};
...
alt_bn128_GT alt_bn128_affine_reduced_pairing(
    const alt_bn128_G1 &P, const alt_bn128_G2 &Q);
