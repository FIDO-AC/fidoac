...
struct mnt4_ate_G1_precomp {
    ...
    friend std::ostream &operator<<(
        std::ostream &out, const mnt4_ate_G1_precomp &prec_P);
    friend std::istream &operator>>(
        std::istream &in, mnt4_ate_G1_precomp &prec_P);
};
...
struct mnt4_ate_dbl_coeffs {
    ...
    friend std::ostream &operator<<(
        std::ostream &out, const mnt4_ate_dbl_coeffs &dc);
...
struct mnt4_ate_add_coeffs {
    ...
    friend std::ostream &operator<<(
        std::ostream &out, const mnt4_ate_add_coeffs &dc);
...
struct mnt4_ate_G2_precomp {
    ...
    friend std::ostream &operator<<(
        std::ostream &out, const mnt4_ate_G2_precomp &prec_Q);
    friend std::istream &operator>>(
        std::istream &in, mnt4_ate_G2_precomp &prec_Q);
};
