...
#ifndef LIBSNARK_GADGETLIB1_GADGETS_FIELDS_FP12_2OVER3OVER2_GADGETS_HPP_
#define LIBSNARK_GADGETLIB1_GADGETS_FIELDS_FP12_2OVER3OVER2_GADGETS_HPP_
...
class Fp12_2over3over2_variable : public gadget<typename Fp12T::my_Fp>
{
public:
...
template<typename Fp12T>
class Fp12_2over3over2_square_gadget : public gadget<typename Fp12T::my_Fp>
{
public:
    using FieldT = typename Fp12T::my_Fp;
    using Fp6T = typename Fp12T::my_Fp6;
...
template<typename Fp12T>
class Fp12_2over3over2_mul_by_024_gadget : public gadget<typename Fp12T::my_Fp>
{
public:
    using FieldT = typename Fp12T::my_Fp;
    using Fp6T = typename Fp12T::my_Fp6;
...
template<typename Fp12T>
class Fp12_2over3over2_mul_gadget : public gadget<typename Fp12T::my_Fp>
{
public:
    using FieldT = typename Fp12T::my_Fp;
    using Fp6T = typename Fp12T::my_Fp6;
...
template<typename Fp12T>
class Fp12_2over3over2_inv_gadget : public gadget<typename Fp12T::my_Fp>
{
public:
    using FieldT = typename Fp12T::my_Fp;
    using Fp2T = typename Fp12T::my_Fp2;
...
#endif // LIBSNARK_GADGETLIB1_GADGETS_FIELDS_FP12_2OVER3OVER2_GADGETS_HPP_
