...
/**
 * A USCS example comprises a USCS constraint system, USCS input, and USCS
 * witness.
 */
template<typename FieldT> struct uscs_example {
 ...
 * - the number of variables of the USCS constraint system is (approximately)
 * num_constraints;
 * - the number of inputs of the USCS constraint system is num_inputs;
 * - the USCS input consists of ``full'' field elements (typically require the
 ...
 * num_constraints;
 * - the number of inputs of the USCS constraint system is num_inputs;
 * - the USCS input consists of binary values (as opposed to ``full'' field
 * elements).
 */
template<typename FieldT>
