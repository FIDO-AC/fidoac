 ...
 *****************************************************************************
 ...
 A compliance predicate handler is a base class for creating compliance
 predicates. It relies on classes declared in gadgetlib1.
...
protected:
    ...
    std::vector<std::shared_ptr<r1cs_pcd_message_variable<FieldT>>>
        incoming_messages;
...
public:
    ...
    std::shared_ptr<r1cs_pcd_message<FieldT>> get_incoming_message(
