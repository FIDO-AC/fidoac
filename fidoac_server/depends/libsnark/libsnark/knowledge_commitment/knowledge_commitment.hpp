...
template<typename T1, typename T2> struct knowledge_commitment {
    ...
    knowledge_commitment<T1, T2>(const knowledge_commitment<T1, T2> &other) =
        default;
    knowledge_commitment<T1, T2>(knowledge_commitment<T1, T2> &&other) =
        default;
    knowledge_commitment<T1, T2> &operator=(
        const knowledge_commitment<T1, T2> &other) = default;
    knowledge_commitment<T1, T2> &operator=(
        knowledge_commitment<T1, T2> &&other) = default;

    knowledge_commitment<T1, T2> add(
        const knowledge_commitment<T1, T2> &other) const;
    knowledge_commitment<T1, T2> mixed_add(
        const knowledge_commitment<T1, T2> &other) const;
