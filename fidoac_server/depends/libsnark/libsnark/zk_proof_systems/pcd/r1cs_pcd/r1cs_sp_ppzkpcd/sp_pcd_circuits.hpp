 ...
 */
template<typename ppT> class sp_compliance_step_pcd_circuit_maker
{
public:
    ...
    std::shared_ptr<r1cs_ppzksnark_verification_key_variable<ppT>>
    ...
    void generate_r1cs_witness(
        const r1cs_ppzksnark_verification_key<other_curve<ppT>>
            &translation_step_pcd_circuit_vk,
 ...
 */
template<typename ppT> class sp_translation_step_pcd_circuit_maker
{
public:
    typedef libff::Fr<ppT> FieldT;
