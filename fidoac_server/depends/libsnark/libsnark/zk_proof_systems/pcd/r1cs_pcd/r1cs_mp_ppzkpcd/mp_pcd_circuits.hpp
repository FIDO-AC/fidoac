 ...
 *
 * The circuit is an R1CS that checks compliance (for the given compliance
 * predicate) and validity of previous proofs.
 */
template<typename ppT> class mp_compliance_step_pcd_circuit_maker
{
public:
    ...
    std::vector<multipacking_gadget<FieldT>>
    ...
    std::vector<r1cs_ppzksnark_verification_key_variable<ppT>>
    ...
    std::shared_ptr<
        set_commitment_variable<FieldT, CRH_with_bit_out_gadget<FieldT>>>
        commitment;
    std::vector<
        set_membership_proof_variable<FieldT, CRH_with_bit_out_gadget<FieldT>>>
        membership_proofs;
    std::vector<set_commitment_gadget<FieldT, CRH_with_bit_out_gadget<FieldT>>>
        membership_checkers;
 ...
 */
template<typename ppT> class mp_translation_step_pcd_circuit_maker
{
public:
    typedef libff::Fr<ppT> FieldT;
    ...
    std::shared_ptr<multipacking_gadget<FieldT>>
