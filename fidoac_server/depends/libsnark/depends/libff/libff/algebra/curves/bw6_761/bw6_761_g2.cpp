...
long long bw6_761_G2::dbl_cnt = 0;
#endif
...
{
    return bw6_761_twist_coeff_b * elt;
}
...
bw6_761_G2 bw6_761_G2::operator-() const
{
...
bw6_761_G2 bw6_761_G2::mixed_add(const bw6_761_G2 &other) const
{
#ifdef DEBUG
...
bw6_761_G2 bw6_761_G2::dbl() const
{
#ifdef PROFILE_OP_COUNTS
    this->dbl_cnt++;
#endif
...
{
    return (bw6_761_Fr::random_element().as_bigint()) * G2_one;
}

void bw6_761_G2::write_uncompressed(std::ostream &out) const
{
    bw6_761_G2 copy(*this);
    copy.to_affine_coordinates();
...
void bw6_761_G2::write_compressed(std::ostream &out) const
{
    bw6_761_G2 copy(*this);
    copy.to_affine_coordinates();
    out << (copy.is_zero() ? 1 : 0) << OUTPUT_SEPARATOR;
...
void bw6_761_G2::read_uncompressed(std::istream &in, bw6_761_G2 &g)
{
    char is_zero;
    bw6_761_Fq tX, tY;
    in >> is_zero >> tX >> tY;
...
void bw6_761_G2::read_compressed(std::istream &in, bw6_761_G2 &g)
{
    char is_zero;
    bw6_761_Fq tX, tY;
    // this reads is_zero;
...
void bw6_761_G2::batch_to_special_all_non_zeros(std::vector<bw6_761_G2> &vec)
{
