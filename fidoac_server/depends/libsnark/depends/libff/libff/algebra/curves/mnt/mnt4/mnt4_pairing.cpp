...
{
    return (
        this->PX == other.PX && this->PY == other.PY &&
...
{
    return (
        this->c_H == other.c_H && this->c_4C == other.c_4C &&
        this->c_J == other.c_J && this->c_L == other.c_L);
}
...
bool mnt4_ate_G2_precomp::operator==(const mnt4_ate_G2_precomp &other) const
{
    return (
        ...
        this->QY2 == other.QY2 && this->QX_over_twist == other.QX_over_twist &&
...
mnt4_Fq4 mnt4_final_exponentiation_last_chunk(
    const mnt4_Fq4 &elt, const mnt4_Fq4 &elt_inv)
{
...
mnt4_Fq4 mnt4_final_exponentiation_first_chunk(
    const mnt4_Fq4 &elt, const mnt4_Fq4 &elt_inv)
{
...
mnt4_affine_ate_G1_precomputation mnt4_affine_ate_precompute_G1(
    const mnt4_G1 &P)
{
...
mnt4_affine_ate_G2_precomputation mnt4_affine_ate_precompute_G2(
    const mnt4_G2 &Q)
{
...
mnt4_Fq4 mnt4_affine_ate_miller_loop(
...
struct extended_mnt4_G2_projective {
    ...
    void test_invariant() const { assert(T == Z.squared()); }
};

void doubling_step_for_flipped_miller_loop(
    extended_mnt4_G2_projective &current, mnt4_ate_dbl_coeffs &dc)
{
...
mnt4_Fq4 mnt4_ate_miller_loop(
    const mnt4_ate_G1_precomp &prec_P, const mnt4_ate_G2_precomp &prec_Q)
{
...
mnt4_Fq4 mnt4_ate_double_miller_loop(
    const mnt4_ate_G1_precomp &prec_P1,
...
mnt4_Fq4 mnt4_miller_loop(
    const mnt4_G1_precomp &prec_P, const mnt4_G2_precomp &prec_Q)
{
    return mnt4_ate_miller_loop(prec_P, prec_Q);
}

mnt4_Fq4 mnt4_double_miller_loop(
    const mnt4_G1_precomp &prec_P1,
