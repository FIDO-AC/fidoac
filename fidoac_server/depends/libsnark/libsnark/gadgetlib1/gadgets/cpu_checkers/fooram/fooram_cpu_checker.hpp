 ...
 *****************************************************************************
 ...
 Starting from empty memory, FOORAM performs non-trivial pseudo-random
 computation that exercises both loads, stores, and instruction fetches.

 E.g. for the first 200 steps on 16 cell machine we get 93 different memory
 configurations.
...
public:
    ...
    void generate_r1cs_witness_other(
