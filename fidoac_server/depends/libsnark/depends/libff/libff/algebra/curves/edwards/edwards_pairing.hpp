...
struct edwards_Fq_conic_coefficients {
    ...
    friend std::istream &operator>>(
        std::istream &in, edwards_Fq_conic_coefficients &cc);
};
...
struct edwards_tate_G2_precomp {
    ...
    friend std::istream &operator>>(
        std::istream &in, edwards_tate_G2_precomp &prec_Q);
};
...
struct edwards_Fq3_conic_coefficients {
    ...
    friend std::istream &operator>>(
        std::istream &in, edwards_Fq3_conic_coefficients &cc);
};
...
struct edwards_ate_G1_precomp {
    ...
    friend std::istream &operator>>(
        std::istream &in, edwards_ate_G1_precomp &prec_P);
};
...
edwards_GT edwards_ate_reduced_pairing(
    const edwards_G1 &P, const edwards_G2 &Q);
