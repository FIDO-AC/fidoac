...
public:
        ...
        , instruction_flags(instruction_flags)
    {
        ...
        /* arithmetic */
        components[tinyram_opcode_AND].reset(new ALU_and_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_OR].reset(new ALU_or_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_XOR].reset(new ALU_xor_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_NOT].reset(new ALU_not_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_ADD].reset(new ALU_add_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_SUB].reset(new ALU_sub_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_MOV].reset(new ALU_mov_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_CMOV].reset(new ALU_cmov_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_CMPA].reset(new ALU_cmp_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_CMPG].reset(new ALU_cmps_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_UMULH].reset(new ALU_umul_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_SMULH].reset(new ALU_smul_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_UDIV].reset(new ALU_divmod_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_SHR].reset(new ALU_shr_shl_gadget<FieldT>(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        /* control flow */
        components[tinyram_opcode_JMP].reset(new ALU_jmp_gadget<FieldT>(
            pb,
            pc,
            arg2val,
            flag,
        ...
        components[tinyram_opcode_CJMP].reset(new ALU_cjmp_gadget<FieldT>(
            pb,
            pc,
            arg2val,
            flag,
        ...
        components[tinyram_opcode_CNJMP].reset(new ALU_cnjmp_gadget<FieldT>(
            pb,
            pc,
            arg2val,
            flag,
