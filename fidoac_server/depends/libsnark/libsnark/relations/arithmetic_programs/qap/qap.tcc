...
qap_instance<FieldT>::qap_instance(
...
template<typename FieldT> size_t qap_instance<FieldT>::num_variables() const
{
    return num_variables_;
}

template<typename FieldT> size_t qap_instance<FieldT>::degree() const
{
    return degree_;
}

template<typename FieldT> size_t qap_instance<FieldT>::num_inputs() const
{
    return num_inputs_;
}

template<typename FieldT>
bool qap_instance<FieldT>::is_satisfied(
    const qap_witness<FieldT> &witness) const
{
    ...
    const qap_instance_evaluation<FieldT> eval_qap_inst(
        this->domain,
        this->num_variables(),
        this->degree(),
        this->num_inputs(),
...
template<typename FieldT>
qap_instance_evaluation<FieldT>::qap_instance_evaluation(
    const std::shared_ptr<libfqfft::evaluation_domain<FieldT>> &domain,
    const size_t num_variables,
    const size_t degree,
    const size_t num_inputs,
...
template<typename FieldT> size_t qap_instance_evaluation<FieldT>::degree() const
{
    return degree_;
}
...
template<typename FieldT>
bool qap_instance_evaluation<FieldT>::is_satisfied(
    const qap_witness<FieldT> &witness) const
{
...
template<typename FieldT>
qap_witness<FieldT>::qap_witness(
    const size_t num_variables,
    const size_t degree,
    const size_t num_inputs,
    const FieldT &d1,
...
template<typename FieldT> size_t qap_witness<FieldT>::num_variables() const
{
    return num_variables_;
}

template<typename FieldT> size_t qap_witness<FieldT>::degree() const
{
    return degree_;
}

template<typename FieldT> size_t qap_witness<FieldT>::num_inputs() const
{
    return num_inputs_;
}
