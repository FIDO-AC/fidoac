...
bool process_demo_command_line(
    const int argc,
    const char **argv,
...
int main(int argc, const char *argv[])
{
    ...
    const ram_ppzksnark_keypair<default_tinyram_ppzksnark_pp> keypair =
        ram_ppzksnark_generator<default_tinyram_ppzksnark_pp>(
    ...
    const ram_ppzksnark_proof<default_tinyram_ppzksnark_pp> proof =
        ram_ppzksnark_prover<default_tinyram_ppzksnark_pp>(
            keypair.pk, boot_trace, auxiliary_input);
    ...
    printf("==================================================================="
           "=============\n\n");
    bool bit = ram_ppzksnark_verifier<default_tinyram_ppzksnark_pp>(
        keypair.vk, boot_trace, proof);
