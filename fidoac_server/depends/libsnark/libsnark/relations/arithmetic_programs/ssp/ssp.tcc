...
ssp_instance<FieldT>::ssp_instance(
...
template<typename FieldT> size_t ssp_instance<FieldT>::num_variables() const
{
    return num_variables_;
}

template<typename FieldT> size_t ssp_instance<FieldT>::degree() const
{
    return degree_;
}

template<typename FieldT> size_t ssp_instance<FieldT>::num_inputs() const
{
    return num_inputs_;
}

template<typename FieldT>
bool ssp_instance<FieldT>::is_satisfied(
    const ssp_witness<FieldT> &witness) const
{
    ...
    const ssp_instance_evaluation<FieldT> eval_ssp_inst(
        this->domain,
        this->num_variables(),
        this->degree(),
        this->num_inputs(),
...
template<typename FieldT>
ssp_instance_evaluation<FieldT>::ssp_instance_evaluation(
    const std::shared_ptr<libfqfft::evaluation_domain<FieldT>> &domain,
    const size_t num_variables,
    const size_t degree,
    const size_t num_inputs,
...
template<typename FieldT> size_t ssp_instance_evaluation<FieldT>::degree() const
{
    return degree_;
}
...
template<typename FieldT>
bool ssp_instance_evaluation<FieldT>::is_satisfied(
    const ssp_witness<FieldT> &witness) const
{
...
template<typename FieldT>
ssp_witness<FieldT>::ssp_witness(
    const size_t num_variables,
    const size_t degree,
    const size_t num_inputs,
    const FieldT &d,
...
template<typename FieldT> size_t ssp_witness<FieldT>::num_variables() const
{
    return num_variables_;
}

template<typename FieldT> size_t ssp_witness<FieldT>::degree() const
{
    return degree_;
}

template<typename FieldT> size_t ssp_witness<FieldT>::num_inputs() const
{
    return num_inputs_;
}
