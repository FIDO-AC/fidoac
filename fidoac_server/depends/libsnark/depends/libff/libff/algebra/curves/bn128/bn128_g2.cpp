...
bool bn128_G2::is_special() const { return (this->is_zero() || this->Z == 1); }

bool bn128_G2::is_zero() const { return Z.isZero(); }
...
bn128_G2 bn128_G2::mul_by_cofactor() const { return bn128_G2::h * (*this); }
...
bool bn128_G2::is_in_safe_subgroup() const
{
...
void bn128_G2::write_compressed(std::ostream &out) const
{
    ...
    out << OUTPUT_SEPARATOR
        << (((unsigned char *)&gcopy.Y.a_)[0] & 1 ? '1' : '0');
}
