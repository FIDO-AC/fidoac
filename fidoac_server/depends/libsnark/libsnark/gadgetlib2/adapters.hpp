...
/**
 * This class is a temporary hack for quick integration of Fp constraints with
 * ppsnark. It is the IDDQD of classes and has "god mode" friend access to many
 * of the gadgetlib classes. This will be refactored out in the future. --Shaul
 */
...
public:
    ...
    typedef ::std::
        tuple<linear_combination_t, linear_combination_t, linear_combination_t>
            constraint_t;
    ...
    static void resetVariableIndex(); ///< Resets variable index to 0 to make
                                      ///< variable indices deterministic.
                                      // TODO: Kill
...
bool operator==(
    const GadgetLibAdapter::linear_combination_t &lhs,
