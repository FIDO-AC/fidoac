 ...
 *****************************************************************************
 ...
 USCS instance with 1000 equations and an input consisting of 10 field elements.
...
int main(int argc, const char *argv[])
{
    ...
    uscs_example<libff::Fr<default_uscs_ppzksnark_pp>> example =
        generate_uscs_example_with_field_input<
            libff::Fr<default_uscs_ppzksnark_pp>>(num_constraints, input_size);
