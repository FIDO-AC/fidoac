...
/**
 * A TBCS example comprises a TBCS circuit, TBCS primary input, and TBCS
 * auxiliary input.
 */
struct tbcs_example {
 ...
 * - selecting a gate type at random (subject to the constraint "output = 0" if
 * this is an output gate).
 */
tbcs_example generate_tbcs_example(
