...
edwards_Fq6 edwards_pp::pairing(const edwards_G1 &P, const edwards_G2 &Q)
{
    return edwards_pairing(P, Q);
}

edwards_Fq6 edwards_pp::reduced_pairing(
